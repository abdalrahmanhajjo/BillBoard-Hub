...
export function TimelineStep({ step, side }: TimelineStepProps) {
  ...
  return (
    <div className="relative md:grid md:grid-cols-2 md:items-center md:gap-20">
      ...
      {/* Content card */}
      <motion.div
        initial={reduceMotion ? false : { opacity: 0, x: onLeft ? -20 : 20, y: 16 }}
      ...
      >
        <div className="group rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-xl sm:rounded-3xl sm:p-8 lg:p-10">
          <div className={cn('flex items-center gap-3 sm:gap-4', onLeft && 'md:flex-row-reverse')}>
            <span className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 transition-transform duration-300 group-hover:scale-110 sm:size-14">
          ...
          <h3
            className={cn(
              'mt-5 text-xl font-semibold text-zinc-900 sm:mt-6',
