      ...
      <Container className="py-20 sm:py-24 lg:py-36">
        ...
        <div className="relative mt-12 sm:mt-16 lg:mt-24">
          <motion.div
            ...
            className="absolute top-0 bottom-0 left-5 w-px origin-top bg-blue-600/35 sm:left-6 lg:left-1/2"
          />
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.article
                  ...
                  className={`group relative ml-10 py-6 sm:ml-12 sm:py-8 lg:ml-0 lg:min-h-56 lg:py-10 ${
                    onRight ? 'lg:pl-10' : 'lg:pr-10'
                  }`}
                >
                  <span
                    aria-hidden
                    className={`absolute top-12 h-px w-5 bg-blue-600/35 sm:top-14 sm:w-6 lg:w-10 ${
                      onRight
                        ? '-left-5 sm:-left-6 lg:-left-10'
                        : '-left-5 sm:-left-6 lg:-right-10 lg:left-auto'
                    }`}
                  />
                  ...
                  <div className="border-t border-zinc-300 pt-7 transition-colors duration-300 group-hover:border-blue-600 dark:border-zinc-700">
                    <div className="flex items-start gap-4 sm:gap-5">
                      <motion.span
                        ...
                        className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-white text-blue-600 shadow-[0_12px_32px_rgba(24,24,27,.07)] transition-colors duration-300 group-hover:bg-blue-600 group-hover:text-white sm:size-14 dark:bg-zinc-900 dark:shadow-none"
                      >
                        <Icon className="size-6" aria-hidden />
                      </motion.span>

                      <div>
                        <h3 className="text-xl font-semibold tracking-[-0.025em] text-zinc-950 sm:text-2xl dark:text-white">
                          {feature.title}
                        </h3>
